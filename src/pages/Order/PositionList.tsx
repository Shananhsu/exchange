...
interface Props {
    orders: TOTrder[];
    handlePositionDetail: (order: TOTrder) => void;
}

const PositionList = ({ orders, handlePositionDetail }: Props) => {
    const { t } = useTranslation();
    return (
        <div className="mx-auto mt-4 h-[calc(100vh-21rem)] w-11/12 rounded-lg bg-arerBgc pb-7">
